...
6. **Write design doc** — save to `.cline/superpowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `.cline/superpowers/specs/YYYY-MM-DD-<topic>-design.md`
